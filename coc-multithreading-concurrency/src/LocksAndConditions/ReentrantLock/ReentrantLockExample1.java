...
class ReentrantLockExample1Main {
    public static void main(String[] args) {
         ...
         * to the JVM's internal AbstractQueuedSynchronizer (AQS). AQS uses CAS
 ...
 * 4. [AQS] The underlying AQS uses an atomic CAS operation. Let's assume T1 wins.
 * 5. [T1] Acquires the lock. Enters the `try` block, sets `isAvailable = true`,
 *    and begins sleeping for 4 seconds.
 * 6. [T2] Fails the CAS operation. The AQS puts T2 into a WAITING queue and uses
